...
/**
 * Provides a BreezyLayoutsThreeColumn Layout Variant plugin.
 *
 * @BreezyLayoutsVariantPlugin(
 *   id = "breezy_three_column",
 *   label = @Translation("Breezy three column"),
 *   description = @Translation("Provides a variant plugin for Breezy three column layout"),
 *   layout = "breezy-three-column",
 *   container = TRUE,
 *   wrapper = TRUE,
 * )
 */
class BreezyLayoutsThreeColumn extends BreezyLayoutsVariantPluginBase implements BreezyLayoutsVariantPluginInterface {
